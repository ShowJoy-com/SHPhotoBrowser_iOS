...
@class SHZoomingScrollView;

@protocol SHZoomingScrollViewDelegate <NSObject>
 ...
 */
- (void)zoomingScrollView:(SHZoomingScrollView *)zoomingScrollView imageLoadProgress:(CGFloat)progress;

@end


@interface SHZoomingScrollView : UIScrollView

/**
 *  zoomingScrollViewdelegate , 要和UIScrollView的delegate区分开
 */
@property (nonatomic , weak) id <SHZoomingScrollViewDelegate> zoomingScrollViewdelegate;
/**
 *  图片加载进度
 */
